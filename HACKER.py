...
\033[1;94mFACEBOOK  AHMAD KHAN
                  
\033[1;92mFB PAGE   AHMAD KHAN
...
logo1 = """
 ...
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |      __      | || |  ____  ____  | || | ____    ____ | || |      __      | || |  ________    | |
| |     /  \     | || | |_   ||   _| | || ||_   \  /   _|| || |     /  \     | || | |_   ___ `.  | |
| |    / /\ \    | || |   | |__| |   | || |  |   \/   |  | || |    / /\ \    | || |   | |   `. \ | |
| |   / ____ \   | || |   |  __  |   | || |  | |\  /| |  | || |   / ____ \   | || |   | |    | | | |
| | _/ /    \ \_ | || |  _| |  | |_  | || | _| |_\/_| |_ | || | _/ /    \ \_ | || |  _| |___.' / | |
| ||____|  |____|| || | |____||____| | || ||_____||_____|| || ||____|  |____|| || | |________.'  | |
| |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
